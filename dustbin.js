class dustbin
{
	constructor(x,y)
	{
		...
		this.leftbody=Bodies.rectangle(x-100+10+40, y-60-10-50-20-100, optuons)
	...
	display()
	{
		...
		fill(255)
			...
			this.image(this.image,this.centerbody.position.x,this.centerbody.position.y-50,100,100)
